...
const LinearCount9Lesson23 = () => {
  ...
  const resetActivity = () => { setShowGame(false); setRockCount(0); setIsComplete(false); };
            ...
            {isComplete && (
              <Card className="bg-gradient-to-br from-emerald-600 via-teal-600 to-sky-600 shadow-2xl rounded-[4rem] overflow-hidden p-16 text-center text-white space-y-10 animate-in zoom-in-95 duration-700">
                ...
                <div className="flex gap-4 w-full pt-8">
                  ...
                  <Button onClick={() => navigate("/activities/module-3?last=3-linear-count-9-lesson-23")} className="h-24 flex-1 bg-white text-emerald-600 hover:bg-rose-50 text-3xl rounded-[2rem] shadow-2xl">Yay! ✨</Button>
                </div>
              </Card>
            )}
